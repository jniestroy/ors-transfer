...
def download_file(download_id):
    ...
    result = send_file('/Users/justinniestroy-admin/Documents/app/' + filename)
    os.remove('/Users/justinniestroy-admin/Documents/app/' + filename)
...
def download_script(bucket,location):
    ...
    with open('/Users/justinniestroy-admin/Documents/app/' + file_name, 'wb') as file_data:
            for d in data.stream(32*1024):
                file_data.write(d)

    return '/Users/justinniestroy-admin/Documents/' + file_name
...
def stardog_eg_csv(ark):
    ...
    with open('/Users/justinniestroy-admin/Documents/star/test.csv','wb') as f:
        f.write(results)
...
def make_eg(ark):
    stardog_eg_csv(ark)
    data = pd.read_csv('/Users/justinniestroy-admin/Documents/star/test.csv')
    eg = build_evidence_graph(data)
    clean_up()
    return eg

def create_named_graph(meta,id):
    with open('/Users/justinniestroy-admin/Documents/star/meta.json','w') as f:
        json.dump(meta, f)
    conn_details = {
        'endpoint': 'http://stardog.uvadcos.io',
        'username': 'admin',
    ...
    with stardog.Connection('db', **conn_details) as conn:
        conn.begin()
        conn.add(stardog.content.File("/Users/justinniestroy-admin/Documents/star/meta.json"),graph_uri='http://ors.uvadcos/'+id)
        conn.commit()
...
def clean_up():
    os.system('rm /Users/justinniestroy-admin/Documents/star/*')
